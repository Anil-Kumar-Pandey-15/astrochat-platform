  ...
  const getFestivals = () => {
    ...
    const festivalsList = [
      ...
      [
        ...
        { name: "वसन्त पंचमी", date: "23 जनवरी", time: "सरस्वती पूजा मुहूर्त: सुबह 07:12 AM से दोपहर 12:35 PM", type: "प्रमुख पर्व" }
      ],
      // Feb (1)
      [
      ...
      [
        ...
        { name: "चैत्र नवरात्रि प्रारंभ", date: "19 मार्च", time: "कलश स्थापना मुहूर्त: सुबह 06:52 AM से 07:43 AM", type: "नवरात्रि" },
        { name: "राम नवमी", date: "26 मार्च", time: "मध्याह्न पूजा मुहूर्त: सुबह 11:13 AM से दोपहर 01:41 PM", type: "प्रमुख पर्व" }
      ],
      // Apr (3)
      [
        { name: "हनुमान जयंती", date: "2 अप्रैल", time: "पूर्णिमा तिथि: मारुति जन्मोत्सव", type: "जयंती" },
        { name: "अक्षय तृतीया", date: "19 अप्रैल", time: "पूजा मुहूर्त: सुबह 05:45 AM से दोपहर 12:18 PM", type: "अबूझ मुहूर्त" },
        { name: "मोहिनी एकादशी", date: "27 अप्रैल", time: "पारण: सुबह 05:28 AM से 08:12 AM", type: "एकादशी व्रत" }
      ],
      // May (4)
      [
        { name: "बुद्ध पूर्णिमा", date: "1 मई", time: "पूर्णिमा तिथि: बुद्ध अवतरण दिवस", type: "पर्व" },
        { name: "वट सावित्री व्रत", date: "16 मई", time: "पूजा मुहूर्त: सुबह 05:23 AM से दोपहर 02:30 PM", type: "सौभाग्य व्रत" },
        { name: "गंगा दशहरा", date: "25 मई", time: "दशमी तिथि: गंगा स्नान का महा मुहूर्त", type: "पर्व" }
      ],
      // Jun (5)
      [
        { name: "निर्जला एकादशी", date: "25 जून", time: "पारण: अगले दिन सुबह 05:24 AM से 08:10 AM", type: "महा व्रत" },
        { name: "वट पूर्णिका व्रत", date: "29 जून", time: "पूजा मुहूर्त: सुबह 05:23 AM से दोपहर 02:30 PM", type: "सौभाग्य व्रत" }
      ],
      // Jul (6)
      [
        { name: "जगन्नाथ रथ यात्रा", date: "16 जुलाई", time: "रथ यात्रा प्रस्थान: दोपहर 02:15 PM से", type: "रथोत्सव" },
        { name: "गुरु पूर्णिमा", date: "29 जुलाई", time: "पूजा मुहूर्त: सुबह 06:45 AM से दोपहर 12:00 PM", type: "प्रमुख पर्व" }
      ],
      // Aug (7)
      [
        { name: "रक्षा बंधन", date: "28 अगस्त", time: "राखी बांधने का शुभ समय: सुबह 05:57 AM से 09:48 AM", type: "प्रमुख पर्व" }
      ],
      // Sep (8)
      [
        { name: "श्री कृष्ण जन्माष्टमी", date: "4 सितंबर", time: "निशीथ पूजा मुहूर्त: रात 11:57 PM से 12:43 AM (5 सितंबर)", type: "महा व्रत" },
        { name: "गणेश चतुर्थी", date: "14 सितंबर", time: "मूर्ति स्थापना मुहूर्त: सुबह 11:03 AM से दोपहर 01:32 PM", type: "प्रमुख पर्व" },
        { name: "अनंत चतुर्दशी", date: "25 सितंबर", time: "अनंत सूत्र धारण समय: सुबह 06:11 AM से रात 11:06 PM", type: "व्रत" }
      ],
      // Oct (9)
      [
        ...
        { name: "शरद पूर्णिमा", date: "25 अक्टूबर", time: "लक्ष्मी पूजा मुहूर्त: रात 11:43 PM से 12:35 AM", type: "पर्व" },
        { name: "करवा चौथ", date: "29 अक्टूबर", time: "चंद्रोदय समय: रात 08:15 PM", type: "पर्व" }
      ],
      // Nov (10)
      [
        ...
        { name: "गोवर्धन पूजा", date: "10 नवंबर", time: "पूजा मुहूर्त: सुबह 06:40 AM से 08:50 AM", type: "पर्व" },
        { name: "भैया दूज", date: "11 नवंबर", time: "टीका लगाने का मुहूर्त: दोपहर 01:10 PM से 03:20 PM", type: "पर्व" },
        { name: "छठ पूजा (संध्या अर्घ्य)", date: "15 नवंबर", time: "अर्घ्यदान (सूर्यास्त समय): शाम 05:28 PM", type: "महा पर्व" }
      ],
      // Dec (11)
      [
                ...
                <Card className="bg-purple-950/5 border-purple-900/20 md:col-span-1">
                  ...
                  <CardContent className="space-y-4 text-sm pt-4">
                    <div className="flex justify-between items-center border-b border-purple-900/10 pb-2">
                      ...
                      <span className="font-semibold text-amber-400">{panchang.sunrise}</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-purple-900/10 pb-2">
                      <span className="text-muted-foreground">{language === 'en' ? 'Sunset' : 'सूर्यास्त'}</span>
                      <span className="font-semibold text-rose-400">{panchang.sunset}</span>
                    </div>
                    <div className="flex justify-between items-center border-b border-purple-900/10 pb-2">
                  ...
                  <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 text-sm">
                    <div className="bg-purple-950/20 p-3 rounded-lg border border-purple-900/10">
                      ...
                      {panchang.tithiEndTime ? (
                        <span className="text-xs text-amber-400 block mt-1">
                          {panchang.tithiEndTime} तक (तदुपरान्त {panchang.tithiNextName})
                        </span>
                      ) : (
                    ...
                    <div className="bg-purple-950/20 p-3 rounded-lg border border-purple-900/10">
                      ...
                      {panchang.nakshatraEndTime ? (
                        <span className="text-xs text-amber-400 block mt-1">
                          {panchang.nakshatraEndTime} तक (तदुपरान्त {panchang.nakshatraNextName})
                        </span>
                      ) : (
                        <span className="text-xs text-amber-400/70 block mt-1">पूर्ण दिन</span>
                      )}
